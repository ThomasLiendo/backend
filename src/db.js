...
const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/eaglesolutions`, {
...
const { Categoria, Subcategoria, Producto, Rol, Usuario, Deposito } = sequelize.models; // añadir modelos
